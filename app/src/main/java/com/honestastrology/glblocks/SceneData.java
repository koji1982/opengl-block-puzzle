...
public class SceneData {
	...
	public static final int LAST_STAGE = 42;
	...
	public static void setStage(int sceneNumber,CurrentScene currentScene){
		...
		switch(sceneNumber){
			...
			case 40://min 1.z11面全てと、z3面z7面の左側隙間ブロックを一つ置きに→multi	
				...
				break;
			case 41:
				cubeCount     = 123;//三面分のcubeから重複分をマイナス
				multipleCount = 3;
				cubeType      = ObjLoader.GRAY_CUBE;
				wallDimension = 2;
				preStagePositionArray = new int[]{
						1,8,8, 1,8,7, 1,8,6, 1,8,5, 1,8,4, 1,8,3, 1,8,2,  1,8,1, 2,8,1, 3,8,1, 4,8,1, 5,8,1, 6,8,1, 7,8,1, 8,8,1,
											 1,7,5, 1,7,4, 1,7,3, 1,7,2,  1,7,1, 2,7,1, 3,7,1, 4,7,1, 5,7,1, 6,7,1, 7,7,1, 8,7,1,
						1,6,8, 1,6,7, 1,6,6, 1,6,5, 1,6,4, 1,6,3, 1,6,2,  1,6,1, 2,6,1, 3,6,1, 4,6,1, 5,6,1, 6,6,1, 7,6,1, 8,6,1,
						1,5,8, 1,5,7, 1,5,6, 1,5,5, 1,5,4, 1,5,3, 1,5,2,  1,5,1, 2,5,1, 3,5,1, 4,5,1, 5,5,1, 6,5,1,		   8,5,1,
						1,4,8, 1,4,7, 1,4,6, 1,4,5, 1,4,4, 1,4,3, 1,4,2,  1,4,1, 2,4,1, 3,4,1, 4,4,1,   	 6,4,1, 7,4,1, 8,4,1,
						1,3,8, 1,3,7, 1,3,6, 1,3,5, 1,3,4, 1,3,3, 1,3,2,  1,3,1, 2,3,1,        4,3,1, 5,3,1, 6,3,1, 7,3,1, 8,3,1,
						1,2,8, 1,2,7, 1,2,6, 1,2,5, 1,2,4, 1,2,3, 1,2,2,  1,2,1, 2,2,1, 3,2,1, 4,2,1, 5,2,1, 6,2,1, 7,2,1, 8,2,1,
						1,1,8, 1,1,7, 1,1,6, 1,1,5, 1,1,4, 1,1,3, 1,1,2,  1,1,1, 2,1,1, 3,1,1, 4,1,1, 5,1,1, 6,1,1, 7,1,1, 8,1,1,
...
//						1,8,8, 1,8,7, 1,8,6, 1,8,5, 1,8,4, 1,8,3, 1,8,2,  1,8,1, 2,8,1, 3,8,1, 4,8,1, 5,8,1, 6,8,1, 7,8,1, 8,8,1,
//						1,7,8, 1,7,7, 1,7,6, 1,7,5, 1,7,4, 1,7,3, 1,7,2,  1,7,1, 2,7,1, 3,7,1, 4,7,1, 5,7,1, 6,7,1, 7,7,1, 8,7,1,
//						1,6,8, 1,6,7, 1,6,6, 1,6,5, 1,6,4, 1,6,3, 1,6,2,  1,6,1, 2,6,1, 3,6,1, 4,6,1, 5,6,1, 6,6,1, 7,6,1, 8,6,1,
//						1,5,8, 1,5,7, 1,5,6, 1,5,5, 1,5,4, 1,5,3, 1,5,2,  1,5,1, 2,5,1, 3,5,1, 4,5,1, 5,5,1, 6,5,1, 7,5,1, 8,5,1,
//						1,4,8, 1,4,7, 1,4,6, 1,4,5, 1,4,4, 1,4,3, 1,4,2,  1,4,1, 2,4,1, 3,4,1, 4,4,1, 5,4,1, 6,4,1, 7,4,1, 8,4,1,
//						1,3,8, 1,3,7, 1,3,6, 1,3,5, 1,3,4, 1,3,3, 1,3,2,  1,3,1, 2,3,1, 3,3,1, 4,3,1, 5,3,1, 6,3,1, 7,3,1, 8,3,1,
//						1,2,8, 1,2,7, 1,2,6, 1,2,5, 1,2,4, 1,2,3, 1,2,2,  1,2,1, 2,2,1, 3,2,1, 4,2,1, 5,2,1, 6,2,1, 7,2,1, 8,2,1,	  
//						1,1,8, 1,1,7, 1,1,6, 1,1,5, 1,1,4, 1,1,3, 1,1,2,  1,1,1, 2,1,1, 3,1,1, 4,1,1, 5,1,1, 6,1,1, 7,1,1, 8,1,1,
				};
				stagePositionArray = convertPositionToFloat(preStagePositionArray);
				...
				break;
			case 42://z埋める方向に後ろ側二列づつ18ブロックmulti、y↓方向に11ブロックmulti
					//x埋める方向に3ブロックと2ブロックでmulti
				cubeCount     = 174;//二面分のcubeから重複分をマイナス
				multipleCount = 4;
				cubeType      = ObjLoader.GRAY_CUBE;
				wallDimension = 2;
				preStagePositionArray = new int[]{
						1,9,9, 1,9,8, 1,9,7, 1,9,6, 1,9,5, 1,9,4, 1,9,3, 1,9,2,  1,9,1, 2,9,1, 3,9,1, 4,9,1, 5,9,1, 6,9,1, 7,9,1, 8,9,1, 9,9,1,
						1,8,9, 1,8,8, 1,8,7, 1,8,6, 1,8,5, 1,8,4, 1,8,3, 1,8,2,  1,8,1, 2,8,1, 3,8,1, 4,8,1, 5,8,1, 6,8,1, 7,8,1, 8,8,1, 9,8,1,
						1,7,9, 1,7,8, 1,7,7, 1,7,6,  	   1,7,4, 1,7,3, 1,7,2,  1,7,1, 2,7,1, 3,7,1, 4,7,1, 5,7,1, 6,7,1, 7,7,1, 8,7,1, 9,7,1,
						1,6,9, 1,6,8, 1,6,7, 1,6,6, 1,6,5, 1,6,4, 1,6,3, 1,6,2,  1,6,1, 2,6,1, 3,6,1, 4,6,1, 5,6,1, 6,6,1, 7,6,1, 8,6,1, 9,6,1,
						1,5,9, 1,5,8, 1,5,7, 1,5,6,  	   1,5,4, 1,5,3, 1,5,2,  1,5,1, 	   3,5,1, 4,5,1,   	     	   7,5,1, 8,5,1, 9,5,1,
						1,4,9, 1,4,8, 1,4,7, 1,4,6,  	   1,4,4, 1,4,3, 1,4,2,  1,4,1, 2,4,1, 3,4,1, 4,4,1, 5,4,1, 6,4,1, 7,4,1, 8,4,1, 9,4,1,
						1,3,9, 1,3,8, 1,3,7, 1,3,6, 1,3,5, 1,3,4, 1,3,3, 1,3,2,  1,3,1, 2,3,1, 3,3,1, 4,3,1, 5,3,1, 6,3,1, 7,3,1, 8,3,1, 9,3,1,
						1,2,9, 1,2,8, 1,2,7, 1,2,6, 1,2,5, 1,2,4, 1,2,3, 1,2,2,  1,2,1, 2,2,1, 3,2,1, 4,2,1, 5,2,1, 6,2,1, 7,2,1, 8,2,1, 9,2,1,	  
						1,1,9, 1,1,8, 1,1,7, 1,1,6, 1,1,5, 1,1,4, 1,1,3, 1,1,2,  1,1,1, 2,1,1, 3,1,1, 4,1,1, 5,1,1, 6,1,1, 7,1,1, 8,1,1, 9,1,1,
