...
public class GLBaseShader {
	...
	public static void createShaderProgram() {
		...
		GLES20.glUniform4f(dirLight_DiffuseHandle, 0.5f, 0.5f, 0.5f, 1.0f);
		GLES20.glUniform4f(dirLight_SpecularHandle, 0.6f, 0.6f, 0.6f, 1.0f);
		GLES20.glUniform3f(dirLight_Direction, 0.30f, 1.00f, 0.45f);
		GLES20.glUniform3f(dirLight_Halfplane, 0.30f, 1.00f, 1.45f);
